...
INSERT INTO questions (id_q, tresc, a, b, c, d, odp, kat ) VALUES (1, ' 
Which one of the following will declare an array and initialize it with five numbers? ', ' int [] a = {23,22,21,20,19};', ' int [5] array;', ' int a [] = new int[5];', 'Array a = new Array(5);', 'a' , 'java' );
